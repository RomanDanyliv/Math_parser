...
public class Math_parser {
    ...
    static double Evaluate(String f, double X)
    {
        String str;
        int i=0, p;
        f = Format_string(f);
    ...
    static String Evaluate_operation(String str, char action)
    {
    ...
    static String Open_brackets(String str, char[] operation)
    {
        int i=0;
        while (true)
        {
    ...
    static String Evaluate_functions(String str, String[] func, char[] operation) {
    ...
    static String Insert_X(String str, double value)
    {
        int X;
